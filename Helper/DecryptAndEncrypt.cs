...
namespace Helper
{
    ...
    public abstract class DecryptAndEncrypt
    {

        /// 
        /// Llave para cifrar informacion
        /// Como buena practica debe ser diferente en cada proyecto
        /// 

        public static IConfiguration configuration;
        private static string ENCRYPTION_KEY = "";
        public DecryptAndEncrypt()
        {


        }

        public static void setCryptoFeed()
        {
            ENCRYPTION_KEY = configuration.GetValue<string>($"CryptoFeed:key");
        }
